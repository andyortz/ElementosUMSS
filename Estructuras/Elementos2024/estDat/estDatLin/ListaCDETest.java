...
public class ListaCDETest
{
    ...
    public void testAcceder1(){
        ...
        assertEquals(new Character('a')  , lista.acceder(1)); 
        assertEquals(false  , lista.vacia()); 
    ...
    public void testCompararDatos(){
        ...
        lista.insertar(new Character('a'));
        lista.insertar(new Character('e'));
        lista.insertar(new Character('f'));
        assertEquals(false,   lista.vacia());
        assertEquals(false,   lista.compararDatos(0,1));
        assertEquals(new Character('a'),   lista.acceder(6));
        assertEquals(true,   lista.compararDatos(0,6));
        assertEquals(true ,   lista.compararDatos(0,3));
    }
    ...
    public void testEquals(){
        ...
        ListaCDE<Character> lista1;
        lista1 = new ListaCDE<Character>(); 
    ...
    public void testInsertar3(){
        ...
        ListaCDE<Character> lista1 = new ListaCDE<Character>();
